...
Q_SIGNALS:
    ...
    void signalUpdateFollowerPose(int, float, float, float, float);
...
public slots:
	...
	void slotSetRobotMove(int inID, float inX, float inY, float inYaw);
...
private:
	...
	void FollowerPoseCallback(const geometry_msgs::PoseArray::ConstPtr& msg);
	int init_argc;
	char** init_argv;
	ros::Subscriber robot_ip_sub;
	ros::Subscriber follower_pose_sub;
	ros::Publisher chatter_publisher;
	ros::Publisher navi_pose_pub;
	ros::Publisher robot_pose_pub;
	ros::Publisher robot_move_pub;
