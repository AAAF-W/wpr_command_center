...
public:
    ...
    CPathItem path_item;
    CFollowerItem arFollowerItem[2];
...
public slots:
    ...
    void slotUpdateFollowerPose(int inIndex, float inLeaderX, float inLeaderY, float inFollowerX, float inFollowerY);

signals:
    void signalSetNaviPos(int,float,float,float);
    void signalSetRobotPos(int,float,float,float);
    void signalSetRobotMove(int,float,float,float);
